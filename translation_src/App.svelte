<script>
  ...
  function get_solution(dt, N, I0, R0, D_incbation, D_infectious, D_recovery_mild, D_hospital_lag, D_recovery_severe, D_death, P_SEVERE, CFR, InterventionTime, InterventionAmt, duration) {
    ...
    function f(t, x){
      ...
      var R_Mild   = x[7] // Phục hồi
      var R_Severe = x[8] // Phục hồi
    ...
    while (steps--) { 
      if ((steps+1) % (sample_step) == 0) {
            //    Dead   Hospital          Phục hồi        Bị nhiễm   Phơi nhiễm
  ...
  function get_milestones(P){
    ...
    for (var i = 0; i < P.length; i++) {
      if (P[i][0] >= 0.5) {
        milestones.push([i*dt, "Ca chết đầu tiên"])
        break
      }
    }

    var i = argmax(P, 1)
    milestones.push([i*dt, "Đỉnh điểm:" + format(",")(Math.round(P[i][1])) + " nhập viện"])
...
<h2>Mô phỏng dịch bệnh (bản gốc ở <a href="http://gabgoh.github.io/COVID/">gabgoh.github.io/COVID/</a>)</h2>
...
<div class="chart" style="display: flex; max-width: 1120px">
  ...
  <div style="flex: 0 0 270px; width:270px;">
    <div style="position:relative; top:48px; right:-115px">
      <div class="legendtext" style="position:absolute; left:-16px; top:-34px; width:50px; height: 100px; font-size: 13px; line-height:16px; font-weight: normal; text-align: center"><b>ngày</b><br> {Math.round(indexToTime(active_))}</div>
      ...
      <div style="position:absolute; left:0px; top:0px; width: 180px; height: 100px">
        ...
        <div class="legend" style="position:absolute;">
          <div class="legendtitle">Dễ mắc</div>
          ...
          <div class="legendtextnum"><span style="font-size:12px; padding-right:2px; color:#CCC">Δ</span> <i>{formatNumber(Math.round(N*get_d(active_)[0]))} / ngày</i>
                                 </div>
          </div>
        </div>
          <div class="legendtext" style="text-align: right; width:105px; left:-111px; top: 4px; position:relative;">Dân số chưa được miễn dịch</div>
      ...
      <div style="position:absolute; left:0px; top:{legendheight*1}px; width: 180px; height: 100px">
        ...
        <div class="legend" style="position:absolute;">
          <div class="legendtitle">Phơi nhiễm</div>
          ...
          <div class="legendtextnum"><span style="font-size:12px; padding-right:2px; color:#CCC">Δ</span> <i>{formatNumber(Math.round(N*get_d(active_)[1])) } / ngày</i>
                                 </div>
          </div>
        </div>
        <div class="legendtext" style="text-align: right; width:105px; left:-111px; top: 4px; position:relative;">Dân số đang trong thời gian ủ bệnh</div>
      ...
      <div style="position:absolute; left:0px; top:{legendheight*2}px; width: 180px; height: 100px">
        ...
        <div class="legend" style="position:absolute;">
          <div class="legendtitle">Bị nhiễm</div>
          <div style="padding-top: 5px; padding-bottom: 1px">
          ...
          <div class="legendtextnum"><span style="font-size:12px; padding-right:2px; color:#CCC">Δ</span> <i>{formatNumber(Math.round(N*get_d(active_)[2])) } / ngày</i>
                                 </div>
          </div>
        </div>
        <div class="legendtext" style="text-align: right; width:105px; left:-111px; top: 4px; position:relative;">Số người <i>đang</i> mắc bệnh</div>
      ...
      <div style="position:absolute; left:0px; top:{legendheight*3}px; width: 180px; height: 100px">
        ...
        <div class="legend" style="position:absolute;">
          <div class="legendtitle">Đã xóa</div>
          ...
          <div class="legendtextnum"><span style="font-size:12px; padding-right:2px; color:#CCC">Δ</span> <i>{formatNumber(Math.round(N*(get_d(active_)[3]+get_d(active_)[4]+get_d(active_)[5]+get_d(active_)[6]+get_d(active_)[7]) )) } / ngày</i>
                                 </div>
          </div>
        </div>
        <div class="legendtext" style="text-align: right; width:105px; left:-111px; top: 4x; position:relative;">Dân số không còn bị nhiễm do cách ly hoặc miễn dịch</div>
      ...
      <div style="position:absolute; left:0px; top:{legendheight*4+14-3}px; width: 180px; height: 100px">
        ...
        <div class="legend" style="position:absolute;">
          <div class="legendtitle">Phục hồi</div>
        ...
        <div class="legendtext" style="text-align: right; width:105px; left:-111px; top: 8px; position:relative;">Khỏi bệnh hoàn toàn.</div>
      ...
      <div style="position:absolute; left:0px; top:{legendheight*4+57}px; width: 180px; height: 100px">
        ...
        <div class="legend" style="position:absolute;">
          <div class="legendtitle">Đang nhập viện</div>
          <div style="padding-top: 3px; padding-bottom: 1px">
          ...
          <div class="legendtextnum"><span style="font-size:12px; padding-right:2px; color:#CCC">Δ</span> <i>{formatNumber(Math.round(N*(get_d(active_)[5]+get_d(active_)[6]))) } / ngày</i>
                                 </div>
        </div>
        <div class="legendtext" style="text-align: right; width:105px; left:-111px; top: 10px; position:relative;">Đang được điều trị</div>
      ...
      <div style="position:absolute; left:0px; top:{legendheight*4 + 120+2}px; width: 180px; height: 100px">
        ...
        <div class="legend" style="position:absolute;">
          <div class="legendtitle">Tử vong</div>
          <div style="padding-top: 3px; padding-bottom: 1px">          
          ...
          <div class="legendtextnum"><span style="font-size:12px; padding-right:2px; color:#CCC">Δ</span> <i>{formatNumber(Math.round(N*get_d(active_)[9])) } / ngày</i>
                                 </div>
          </div>
        </div>
        <div class="legendtext" style="text-align: right; width:105px; left:-111px; top: 10px; position:relative;">Số người chết</div>
      </div>
    </div>
  </div>
    ...
    <div style="position:relative; top:60px; left: 10px">
      ...
      <div style="position: absolute; width:{width+15}px; height: {height}px; position: absolute; top:100px; left:10px; pointer-events: none">
        ...
        <div id="interventionDrag" class="legendtext" style="flex: 0 0 160px; width:120px; position:relative;  top:-70px; height: 60px; padding-right: 15px; left: -125px; pointer-events: all;cursor:col-resize;" >
          <div class="paneltitle" style="top:9px; position: relative; text-align: right">Can thiệp vào ngày {format("d")(InterventionTime)}</div>
      ...
      <div style="position: absolute; width:{width+15}px; height: {height}px; position: absolute; top:120px; left:10px; pointer-events: none">
        <div style="
            ...
            <div style="flex: 0 0 160px; width:200px; position:relative; top:-125px; left: 1px" >
              ...
              <div class="paneldesc">để giảm sự truyền nhiễm đến mức<br></div>
              </div>
...
<!-- 
    ...
    <div style="opacity:{xScaleTime(InterventionTime) >= 192? 1.0 : 0.2}">
      <div class="tick" style="color: #AAA; position:absolute; pointer-events:all; left:10px; top: 10px">
        <Checkbox color="#CCC" bind:checked={log}/><div style="position: relative; top: 4px; left:20px">thang đo tuyến tính</div>
      </div>
    </div>
...
<div style="height:220px;">
  <div class="minorTitle">
    <div style="margin: 0px 0px 5px 4px" class="minorTitleColumn">Động lực học của sự truyền nhiễm</div>
    <div style="flex: 0 0 20; width:20px"></div>
    <div style="margin: 0px 4px 5px 0px" class="minorTitleColumn">Động lực học lâm sàng</div>
  </div>
  <div class = "row">

    <div class="column">
      <div class="paneltitle">Dân số ban đầu</div>
      <div class="paneldesc" style="height:30px">Quy mô dân số<br></div>
      ...
      <div class="paneldesc" style="height:29px; border-top: 1px solid #EEE; padding-top: 10px">Số lượng người nhiễm ban đầu<br></div>
    ...
    <div class="column">
      <div class="paneltext">
      <div class="paneltitle">Hệ số lây lan cơ bản {@html math_inline("\\mathcal{R}_0")} </div>
      <div class="paneldesc">Đo lường mức độ lây nhiễm: số lượng lây nhiễm thứ cấp mà mỗi cá nhân bị nhiễm bệnh tạo ra <br></div>
      </div>
    ...
    <div class="column">
      ...
      <div class="slidertext">{D_infectious} ngày</div>
    ...
    <div class="column">
      <div class="paneltitle">Thống kê tỷ lệ mắc bệnh</div>
      <div class="paneldesc" style="height:30px">Tỷ lệ tử vong<br></div>
      ...
      <div class="paneldesc" style="height:29px; border-top: 1px solid #EEE; padding-top: 10px">Thời gian từ sau khi ủ bệnh đến khi chết<br></div>
      <div class="slidertext">{Time_to_death} ngày</div>
      <input class="range" type=range bind:value={Time_to_death} min={(D_infectious)+0.1} max=100 step=0.01>
    </div>

    <div class="column">
      <div class="paneltitle">Thời gian phục hồi</div>
      <div class="paneldesc" style="height:30px">Thời gian nằm viện<br></div>
      <div class="slidertext">{D_recovery_severe} ngày</div>
      <input class="range" style="margin-bottom: 8px" type=range bind:value={D_recovery_severe} min={0.1} max=100 step=0.01>
      <div class="paneldesc" style="height:29px; border-top: 1px solid #EEE; padding-top: 10px">Thời gian phục hồi cho các ca nhiễm nhẹ<br></div>
      <div class="slidertext">{D_recovery_mild} ngày</div>
      <input class="range" type=range bind:value={D_recovery_mild} min={0.5} max=100 step=0.01>
    </div>

    <div class="column">
      <div class="paneltitle">Thống kê chăm sóc</div>
      <div class="paneldesc" style="height:30px">Tỷ lệ nhập viện<br></div>
      ...
      <div class="paneldesc" style="height:29px; border-top: 1px solid #EEE; padding-top: 10px">Thời gian trước khi nhập viện<br></div>
      <div class="slidertext">{D_hospital_lag} ngày</div>
...
<table style="width:100%; margin:auto; font-weight: 300; border-spacing: inherit">
  <tr>
    <th></th>
    <th>Địa điểm</th>
    <th>Hệ số lây lan<br> {@html math_inline("\\mathcal{R}_0")}</th>
    <th>Thời gian ủ bệnh<br> {@html math_inline("T_{\\text{inc}}")} (tính theo ngày)</th>
    <th>Thời gian gây lây nhiễm<br> {@html math_inline("T_{\\text{inf}}")} (tính theo ngày)</th>
  </tr>
  <tr>
...
<p class="center">
Please DM me feedback <a href="https://twitter.com/gabeeegoooh">here</a> or email me <a href="mailto:izmegabe@gmail.com">here</a>. Trang <a href="http://gabgoh.github.io/">web của tôi</a>.
</p>
<!-- 
<p class="center">
